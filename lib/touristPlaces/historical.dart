  ...
  final List<Map<String, dynamic>> places = [
    {
      ...
      'location': LatLng(29.9792, 31.1342), // إحداثيات الأهرامات
    },
    {
      'name': 'سقارة',
      'image': 'assets/images/saqqara.jpg',
      'description': 'سقارة مكان عريق',
      'location': LatLng(29.8717, 31.2163), // إحداثيات سقارة
    },
    {
      'name': 'معبد أبو سمبل',
      'image': 'assets/images/abu_simbel.jpg',
      'description': 'معبد أبو سمبل مكان عريق',
      'location': LatLng(22.3372, 31.6258), // إحداثيات معبد أبو سمبل
    },
    {
      'name': 'طريق الكباش',
      'image': 'assets/images/طريق_الكباش.jpg',
      'description': 'طريق الكباش مكان عريق',
      'location': LatLng(25.6967, 32.6396), // إحداثيات طريق الكباش
    },
  ];
              ...
              Row(
                children: List.generate(5, (index) {
                  return Icon(
                    ...
                    color: index < 4
                        ? Colors.amber
                        : Colors.grey, // تقييم مبدئي بـ 4 نجوم
                    size: 30,
                  );
                }),
              ),
